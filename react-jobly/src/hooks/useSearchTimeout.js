...
/** Runs a callback on initial render and after a certain delay whenever the trigger value is changed. Resets timer if trigger changes before the timer expires.
 *
